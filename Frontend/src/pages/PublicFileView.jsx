    ...
    <div className="bg-gray-50 min-h-screen">
      <header className="p-4 border-b bg-white">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl text-gray-800">ShareSphere</span>
          </div>
          <button
            onClick={openShareModal}
            className="flex items-center gap-2 px-4 py-2 bg-orange-50 text-red-600 rounded-lg hover:bg-orange-100 transition-colors"
          >
            <Copy size={18} />
            Share Link
          </button>
      ...
      <main className="container mx-auto p-4 md:p-8 flex justify-center">
        <div className="w-full max-w-3xl">
          <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-8 text-center">
            ...
            <div className="flex justify-center gap-4 my-8">
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-red-800 text-white rounded-lg hover:bg-red-700 transition-colors shadow"
              >
                <Download size={18} />
                Download File
              </button>
          ...
          <div className="mt-6 bg-yellow-50 border border-yellow-200 text-yellow-800 p-4 rounded-lg flex items-center gap-4">
            <Info size={20} />
            <p className="text-sm">
