...
const DashboardUpload = ({ files, onFileChange, onUpload, uploading, onRemoveFile, remainingUploads }) => {
    ...
    return (
        <div className="w-full">
            ...
            <div
                className="border-dashed border-2 border-gray-300 rounded-lg p-6 text-center bg-white cursor-pointer hover:border-red-500 transition-colors"
            ...
            >
                <div className="flex flex-col items-center justify-center">
                    <div className="p-2 rounded-full bg-purple-50 mb-3">
                        <ArrowUpFromLine size={20} className="text-red-500" />
                    </div>
            ...
            {files.length > 0 && (
                <div className="mt-3">
                    <button
                        ...
                        className="w-full py-2 bg-red-500 text-white text-sm rounded-md hover:bg-red-600 disabled:opacity-50 flex items-center justify-center gap-2 transition-colors"
                    >
                        {uploading ? (
                            <>
