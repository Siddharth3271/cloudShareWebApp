...
public class ClerkWebhookController {
    ...
    public ResponseEntity<?> handleClerkWebhook(@RequestHeader("svix-id") String svixId, @RequestHeader("svix-timestamp") String svixTimestamp, @RequestHeader("svix-signature") String svixSignature, @RequestBody String payload){
        ...
        try{
            boolean isValid=verifyWebhookSignature(svixId,svixTimestamp,svixTimestamp,payload);
            if(!isValid){
    ...
    private boolean verifyWebhookSignature(String svixId, String svixTimestamp, String svixTimestamp1, String payload) {
