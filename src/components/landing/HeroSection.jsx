                    ...
                    <span className="block text-red-500">ShareSphere</span>
                        ...
                        <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
                            <div className="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5">
                                ...
                                <button
                                onClick={()=>openSignUp()}
                                className='flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-red-500 hover:bg-red-600 md:py-4 md:text-lg md:px-10 transition-all duration-200 shadow-lg hover:shadow-xl cursor-pointer'>Get Started</button>
                                
                                <button
                                onClick={()=>openSignIn()}
                                className='flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-200 md:py-4 md:text-lg md:px-10 transition-all duration-200 shadow-lg hover:shadow-xl cursor-pointer'>Sign In</button>
                            </div>
