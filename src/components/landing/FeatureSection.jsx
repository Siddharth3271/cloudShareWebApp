...
import { ArrowUpCircle, CreditCard, FileText, Clock, Shield, Share2 } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-600">
            ShareSphere offers a comprehensive suite of features designed to make file sharing simple, secure, and efficient.
          </p>
        </div>
        <div className="mt-16">
